...
export const moveClassAction = server$(async function (id: number, direction: 'up' | 'down') {
  const response = await fetch(`${this.url.origin}/api/classes`, {
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json' },
...
export default component$(() => {
  ...
  const saveEdit = $(async () => {
    ...
    try {
      loadingMessage.value = 'Updating class...';
      errorMessage.value = '';
  ...
  const deleteClass = $(async (id: number) => {
    ...
    try {
      loadingMessage.value = 'Deleting class...';
      errorMessage.value = '';
  ...
  const moveClass = $(async (id: number, direction: 'up' | 'down') => {
    try {
      loadingMessage.value = 'Reordering class...';
      errorMessage.value = '';
      await moveClassAction(id, direction);
